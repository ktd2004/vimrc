...
fun! LoadTemplateFile()
	...
	elseif filereadable(expand($VIM . "/vimfiles/" . template_file))
		call LoadTemplateFileConfirm($VIM . "/vimfiles/" . template_file)
	...
	let myfile_e = expand("%:t")
	let inc_gaurd = substitute(myfile_e, "\\.", "_", "g")
